...
//
const multiaddrs = [
    // '/dns4/ipfs.le-space.de/tcp/9090/p2p/12D3KooWAJjbRkp8FPF5MKgMU53aUTxWkqvDrs4zc1VMbwRwfsbE',
    '/dns4/ipfs.le-space.de/tcp/443/wss/p2p/12D3KooWAJjbRkp8FPF5MKgMU53aUTxWkqvDrs4zc1VMbwRwfsbE'
...
export const config = {
    ...
    services: {
        ...
        identify: identify(),
        autoNAT: autoNAT({ startupDelay:5000}),
        dcutr: dcutr(),
